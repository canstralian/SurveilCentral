        ...
        <main className="flex-1 p-6 overflow-auto">
          ...
          <div className="mb-6">
            <div className="flex items-center justify-between mb-4">
              <h2 className="text-2xl font-bold">Live Camera Monitoring</h2>
              <div className="flex items-center space-x-4">
                ...
                <div className="flex items-center space-x-2 bg-muted p-2 rounded-lg">
                  ...
                  <select 
                    ...
                    className="bg-white border border-border rounded px-3 py-1 text-sm"
                ...
                <button 
                  className="px-4 py-2 bg-accent text-accent-foreground rounded-lg hover:bg-muted transition-colors"
                  data-testid="button-discover-cameras"
                >
                  <i className="fas fa-search mr-2"></i>Discover Cameras
                </button>
              </div>
            </div>
